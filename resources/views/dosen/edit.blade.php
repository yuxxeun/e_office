...
@section('breadcrumb')
    <ul class="breadcrumb">
        ...
        <li>
            <a class="active" href="{{ route('dosen.update', $dosen->nip) }}">Edit {{ $dosen->nama_dosen }}</a>
        </li>
    </ul>
@endsection
...
@section('form_input')
    <div class="table-data">
        <div class="order">
        @section('title_surat', 'Edit Data Dosen')

        <form action="{{ route('dosen.update', $dosen->nip) }}" class="form" method="post">
            @csrf
            @method('PUT')
            <div class="input-box">
                <label>NIP</label>
            ...
            <div class="button">
                ...
                <button type="submit" class="show_confirm">Submit</button>
            </div>
