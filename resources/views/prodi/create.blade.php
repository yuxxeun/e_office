...
@section('breadcrumb')
    <ul class="breadcrumb">
        ...
        <li>
            <a class="active" href="{{ route('prodi.create') }}">Tambah Prodi</a>
        </li>
    </ul>
@endsection
...
@section('form_input')
    <div class="table-data">
        <div class="order">
        @section('title_surat', 'Tambah Prodi')
        <form action="{{ route('prodi.store') }}" class="form" method="post">
            @csrf
            <div class="input-box">
                <label>Nama Program Studi</label>
                <input type="text" name="nama_prodi" placeholder="Masukkan nama program studi" required />
            </div>
            <select name="id_dosen" class="input-box address">
                <label>Koordinator Prodi</label>
                <div class="select-box">
                    <option value="">
                        Pilih Koordinator prodi
                    </option>
