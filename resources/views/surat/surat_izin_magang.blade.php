...
@section('title_surat', 'Izin Magang/PKL')
@section('breadcrumb')
<ul class="breadcrumb">
    <li>
    ...
    <li>
        <a class="active" href="{{ route('suket.magang') }}">Surat Izin Magang</a>
    </li>
</ul>
@endsection
@section('form_input')
<div class="table-data">
    <div class="order">
    @section('title_surat', 'Surat Keterangan Izin Magang')
    <form action="{{ route('suket.magangStore') }}" class="form" method="post">
        @csrf
        <div class="input-box">
