...
function AwesomeChart(canvasElementId) {
    ...
    this.draw = function () {
        ...
        if (this.proportionalSizes) {
            ...
            this.yAxisLabelMargin =
                this.yAxisLabelMargin * this.heightSizeFactor;
        ...
        if (this.title != null) {
            ...
            context.fillText(
                this.title,
                this.width / 2,
                this.marginTop + this.titleFontHeight,
                this.width - 10
            );
        }
    ...
    this.drawBarChart = function () {
        ...
        var maxBarHeight = Math.max(
            Math.abs(barBottomY - barMaxTopY),
            Math.abs(barBottomY - barMinTopY)
        );
            ...
            if (this.labels[i]) {
                if (di >= 0) {
                    ...
                    context.fillText(
                        this.labels[i],
                        x + barWidth / 2,
                        barBottomY - barHeight - this.labelMargin,
                        barWidth
                    );
                } else {
    ...
    this.drawVerticalBarChart = function () {
        ...
        var barMaxTopY =
            this.marginTop +
            Math.max(
                this.labelMargin + maxLabelWidth,
                this.dataValueMargin + maxDataValueWidth
            );
    ...
    this.drawPieChart = function (ring) {
        ...
        if (this.title) {
            pieAreaHeight =
                pieAreaHeight - this.titleFontHeight - this.titleMargin;
        }
            ...
            if (this.labels[i]) {
                if (
                    ...
                    var translateXBy =
                        radius +
                        this.labelMargin +
                        context.measureText(this.labels[i]).width / 2;
    ...
    this.drawParetoChart = function () {
        ...
        for (var i = 1; i < 10; i++) {
            yAxisValues.push(
                ((dataSum * i) / 10).toFixed(this.numberOfDecimals)
            );
        }
        ...
        for (var i = 0; i <= 10; i++) {
            ...
            context.fillText(
                yAxisValues[10 - i],
                -this.chartMarkerSize - this.yAxisLabelMargin,
                lineY
            );
        ...
        for (var i = 0; i < this.data.length; i++) {
            ...
            if (this.data[indices[i]] >= 0) {
                ...
                context.fillText(
                    this.data[indices[i]],
                    x + halfBarWidth,
                    -barHeight - this.labelMargin - this.dataValueMargin,
                    barWidth
                );
            } else {
                context.textBaseline = "top";
