...
function edit_inline(elm, url, tabel, nama_id) {
    ...
    if (index_pil >= 0) {
        var elm_select =
            buat_select(nilai_td, titel) +
            "<span class='save-inline' onclick=\"update_inline(this,'" +
            url +
            "','" +
            tabel +
            "','" +
        ...
        if (titel == "tgl_lahir") {
            $(elm).html(
                "<input class='text' onfocus='buat_date(this)' type='text' name='" +
                    titel +
                    "' value='" +
                    nilai_td +
                    "' size='" +
    ...
    $(
        ...
        buttons: {
            Hapus: function () {
                ...
                $.post(
                    url,
                    { data: idnya, nama_id: nama_id, tabel: nama_tabel },
                    function (data) {
                        if (data == 1) {
