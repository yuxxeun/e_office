        ...
        d.each(e, function () {
            c || (f -= parseFloat(d.css(a, "padding" + this)) || 0),
                c === "margin"
                    ...
                    : (f -=
                          parseFloat(d.css(a, "border" + this + "Width")) || 0);
        });
        return f;
    }
    function ba(a, b) {
                        ...
                        for (; j < k; j++)
                            if ((a = arguments[j]) != null)
                                for (c in a) {
                                    ...
                                    l &&
                                    f &&
                                    (d.isPlainObject(f) || (g = d.isArray(f)))
                                        ? (g
                                              ? ((g = !1),
                                                (h =
                                                    e && d.isArray(e) ? e : []))
                    ...
                    if (b) {
                        (a.style.width = a.style.paddingLeft = "1px"),
                            ...
                            "zoom" in a.style &&
                                ...
                                (a.style.zoom = 1),
                                (d.support.inlineBlockNeedsLayout =
                                    a.offsetWidth === 2),
                                (a.style.display = ""),
                                (a.innerHTML =
            ...
            clean: function (a, b, e, f) {
                ...
                if (e)
                    for (h = 0; g[h]; h++)
                        ...
                        (g[h].type &&
                            g[h].type.toLowerCase() !== "text/javascript")
                            ? (g[h].nodeType === 1 &&
                                  g.splice.apply(
                                      g,
                                      [h + 1, 0].concat(
        ...
        animate: function (a, b, c, e) {
            ...
            return this[f.queue === !1 ? "each" : "queue"](function () {
                ...
                for (c in a) {
                    ...
                    d.isArray(a[c]) &&
                        (((b.specialEasing = b.specialEasing || {})[c] =
                            a[c][1]),
                        (a[c] = a[c][0]));
                }
        ...
        (d.fx.prototype = {
            ...
            custom: function (a, b, c) {
                ...
                (this.startTime = d.now()),
                    ...
                    (this.end = b),
                    (this.unit =
                        c || this.unit || (d.cssNumber[this.prop] ? "" : "px")),
                    (this.now = this.start),
    ...
    "getBoundingClientRect" in c.documentElement
        ? (d.fn.offset = function (a) {
              ...
              var h = f.body,
                  ...
                  l =
                      i.pageYOffset ||
                      (d.support.boxModel && g.scrollTop) ||
                      h.scrollTop,
                  m =
                      i.pageXOffset ||
